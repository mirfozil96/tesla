...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const VerticalSliderYoqish(),
    );
  }
}

class VerticalSliderYoqish extends StatefulWidget {
  const VerticalSliderYoqish({super.key});
  @override
  State<VerticalSliderYoqish> createState() => _VerticalSliderYoqishState();
}

class _VerticalSliderYoqishState extends State<VerticalSliderYoqish> {
  @override
  Widget build(BuildContext context) {
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    offset: Offset(5 * changeSize,
                        5 * changeSize), // Offsetni ham moslashtirish kerak
